...
<form id="form2" action="show_result.php" method="post" enctype="multipart/form-data" class="container mt-5" style="padding-top: 80px;">
    ...
    <div class="mb-3">
        ...
        <input type="file" name="pdf_file" id="pdf_file" accept=".pdf, .jpeg, .jpg, .png" class="form-control" required>
    </div>
