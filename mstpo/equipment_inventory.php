...
<head>
    ...
    <style>
        ...
        body {
            padding-top: 60px; /* Adjust the top padding to accommodate the fixed header */
        }
...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="border: solid; height: 100vh;">
                <iframe id="iframe_content" src="equipment_data.php" frameborder="0" width="100%" height="1000"></iframe>
            </main>
        </div>
    </div>
</body>
