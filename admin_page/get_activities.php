...
if (isset($_GET['selected_date'])) {
    ...
    $sql = "SELECT id, scheduled_date, start_time, facility_id FROM facility_schedules WHERE scheduled_date = ?";
                    ...
                    if ($stmtFaci) {
                        ...
                        if ($resultFaci->num_rows > 0) {
                            while ($rowFaci = $resultFaci->fetch_assoc()) {
                                ...
                                echo '<div class="image" style="border: solid; background-image: url(' . $imagePath . ');"></div>';
                                echo '</div>';
