        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar" style="top: 60px;">
            <div class="position-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) === 'facility_logs.php' ? 'active' : ''; ?>" href="facility_logs.php">
                            <i class="fas fa-tasks"></i> Facility Logs
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="top: 60px; border:solid; height: 89vh;">
                ...
                <iframe id="iframe_content" src="logs_faci.php" frameborder="0" width="100%" height="450"></iframe>
            </main>
        </div>
    </div>
