...
<head>
    ...
    <style>
        ...
        .request-container {
            ...
            color: #333; /* Added for better text readability */
        }
...
if ($result) {
    while ($row = $result->fetch_assoc()) {
        ...
        $status = $row["status"]; // Assuming you have a 'status' column
        ...
        echo '</div>'; // Close facility container
        ...
        echo '<a href="#" onclick="updateStatus(' . $row["id"] . ', \'approved\')" class="action-button">Check</a>';
...
<script>
    ...
    function deleteRequest() {
        // Get the request ID and status from the data attributes
        ...
        // Implement your logic to delete the request
        // For demonstration, let's use AJAX to update the database

        // Assuming you have a separate PHP file to handle the deletion (e.g., delete_request.php)
